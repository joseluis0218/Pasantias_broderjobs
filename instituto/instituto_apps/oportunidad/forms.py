...
class OportunidadForm(forms.ModelForm):
    ...
    class Meta:
        model = Oportunidad
        fields = ('titulo', 'carga_horaria', 'remuneracion', 'remuneracion_min', 'remuneracion_max','pais','ciudad',
        ...
        widgets = {
            ...
            'carrera': SelectMultiple(attrs={'class': 'select2 m-b-10 select2-multiple','style': 'width:100%;','data-placeholder': 'Seleccione','multiple': 'multiple'}),
            'rama_carrera': SelectMultiple(attrs={'class': 'select2 m-b-10 select2-multiple','style': 'width:100%;','data-placeholder': 'Seleccione','multiple': 'multiple','required':'required'}),
            'idioma': SelectMultiple(attrs={'class': 'select2 m-b-10 select2-multiple','style': 'width:100%;','data-placeholder': 'Seleccione','multiple': 'multiple'}),
            ...
            'conocimiento': SelectMultiple(attrs={'class': 'select2 m-b-10 select2-multiple','style': 'width:100%;','data-placeholder': 'Seleccione','multiple': 'multiple'}),
