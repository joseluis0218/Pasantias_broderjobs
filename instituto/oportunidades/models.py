...
class Oportunidad(models.Model):
    ...
    grado_estudio = models.ManyToManyField(GradoEstudio, default=None, blank=True, verbose_name="grado estudios")
    ...
    graduacion_desde = models.ForeignKey(PeriodosGraduacion, default=None,  null=True, blank=True, related_name="graduacion_desde",on_delete=True)
    graduacion_hasta = models.ForeignKey(PeriodosGraduacion, default=None,  null=True, blank=True, related_name="graduacion_hasta",on_delete=True)
    ...
    division = models.ForeignKey(EmpresaDivision, default=None, null=True, blank=True,on_delete=True)
    area_experiencia =  models.ForeignKey(AreaExpeiencia, default=None, null=True, blank=True,on_delete=True)
    tiempo_experiencia =  models.ForeignKey(TiempoExpeiencia, default=None, null=True, blank=True,on_delete=True)
